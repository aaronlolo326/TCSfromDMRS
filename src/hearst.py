    ...
    def __init__(self, extended=False):
        ...
        self.__hearst_patterns = [
            ...
            (
                ...
                '(NP_\w+,? such as NP_\w+(, NP_\w+)*(,?( and | or | )?NP_\w+)*)',
                'first'
            ),
            (
                # '(such NP_\\w+ (, )?as (NP_\\w+ ?(, )?(and |or )?)+)',
                '(such NP_\w+,? as NP_\w+(, NP_\w+)*(,?( and | or | )?NP_\w+)*)',
                'first'
            ),
            (
                # '((NP_\\w+ ?(, )?)+(and |or )?other NP_\\w+)',
                '(NP_\w+(, NP_\w+)*(,?( and | or | )?other NP_\w+)*)',
                'last'
            ),
            (
                # '(NP_\\w+ (, )?include (NP_\\w+ ?(, )?(and |or )?)+),
                '(NP_\w+,? include NP_\w+(, NP_\w+)*(,?( and | or | )?NP_\w+)*)',
                'first'
            ),
            (
                # '(NP_\\w+ (, )?especially (NP_\\w+ ?(, )?(and |or )?)+)',
                '(NP_\w+,? especially NP_\w+(, NP_\w+)*(,?( and | or | )?NP_\w+)*)',
                'first'
            ),
        ]
